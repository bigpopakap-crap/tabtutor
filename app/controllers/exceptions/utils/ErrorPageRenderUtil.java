...
public abstract class ErrorPageRenderUtil {
	 ...
	 */
	public static Html goTo(Throwable ex, String description, String url, String toMessage) {
	...
	public static Html goBack(Throwable ex, String description) {
		return goTo(ex, description, "javascript:history.back()", Message.errorPage_toGoBack.get());
	}
	
	/** A page with a link to go back home */
	public static Html goHome(Throwable ex, String description) {
		return goTo(ex, description, "/", Message.errorPage_toGoHome.get());
	}
